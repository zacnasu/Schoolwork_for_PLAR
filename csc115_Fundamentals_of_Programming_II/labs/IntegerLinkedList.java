public class IntegerLinkedList {
	...
	private void doubleall(IntegerNode a){
		if(a == null){
			return;
		}
		else{
			this.setElement(this.getElement*2);
			doubleall(a.next);
		}
	}
	...
	private void doubleOdd(IntegerNode n, int pos){
		if(n==null){
			return;
		}
		else{
	...
	private int sum(IntegerNode n){
		if(n==null){
			...
			return this.getElement()+sum(n.getNext());
		}
	}
	...
	private int sum(IntegerNode n){
		if(n==null){
			...
			return this.getElement()*product(n.getNext());
		}
	}
    ...
    private boolean sorted(IntegerNode current){
		if(n==null){
			return true;
		}
		if(n.getNext() == null){

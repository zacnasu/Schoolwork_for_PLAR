 ...
 * A5Tester.java
 *
 * A partial test program for Assignment 5.
 *
...
public class A5Tester {
    ...
    public static boolean testLinkedList = true;
    ...
    public static PlayerListInterface createList() {
    ...
    public static void playerListTestOne() {
        ...
        PlayerListInterface l = createList();
    ...
    public static void testAddRemoveLinked() {
        ...
        Player p0 = new Player(Integer.toString(num+0));
        Player p1 = new Player(Integer.toString(num+1));
        Player p2 = new Player(Integer.toString(num+2));
        Player p3 = new Player(Integer.toString(num+3));
        Player p4 = new Player(Integer.toString(num+4));
        Player p5 = new Player(Integer.toString(num+5));
